...
- `apps/web` — TanStack Start (React 19 + React Compiler, TanStack Query, zustand, react-hook-form, react-error-boundary, Tailwind v4, Vitest + RTL). 실제 UI/로직은 전부 여기. **컨벤션은 `web-stack`/`web-testing` skill 참조.**
...
- 모바일 변경: `cd apps/mobile && pnpm exec tsc --noEmit`
